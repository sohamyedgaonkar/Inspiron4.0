...
import { Menu, X, Star, Sprout, Users, GraduationCap, Layout, BookOpen, BrainCircuit, FileText, User } from "lucide-react";
...
const Navigation = () => {
  ...
  const navItems = [
    // Main learning path
    { name: "Dashboard", path: "/dashboard", icon: <Layout className="h-4 w-4" /> },
    { name: "Course", path: "/course", icon: <BookOpen className="h-4 w-4" /> },
    { name: "Quiz", path: "/quiz", icon: <BrainCircuit className="h-4 w-4" /> },
